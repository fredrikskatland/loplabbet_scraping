...
class LopeskoSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield scrapy.Request('https://www.loplabbet.no/kategorier/dame/lopesko/konkurransesko?sortOrder=CreatedDescending&numProducts=1000'
                             , meta=dict(
                                 playwright=True,
